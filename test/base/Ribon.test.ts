...
import { Ribon, TestERC20PermitAllowed } from "../../typechain"
...
describe("Ribon", function () {
  ...
  const fixture: Fixture<{
    donationToken: TestERC20PermitAllowed
    ribon: Ribon
  }> = async (wallets, provider) => {
    const donationTokenFactory = await ethers.getContractFactory('TestERC20PermitAllowed')
    const donationToken = (await donationTokenFactory.deploy(100000)) as TestERC20PermitAllowed
  ...
  let donationToken: TestERC20PermitAllowed;
  let ribon: Ribon;
